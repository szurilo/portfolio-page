  ...
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <div class="mt-8 overflow-hidden p-6">
        <img src="~assets/avatar.png" class="w-36 h-36 rounded-full float-right" />
      ...
      <p class="mt-3 text-gray-600">
        I am full stack web developer. I love projects that make the world a better place.
      </p>
      <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">
        I have more than 10 years of experience in developing all kinds of software solutions. My expertiese is ...
      </p>
